package com.example.helenapopova.sqlexperiense.loaders;
...
public class LoaderTime extends Loader<String> {
    ...
    public LoaderTime(Context context) {
        super(context);
    }

    public LoaderTime(Context context, Bundle args) {
        super(context);
    ...
    class GetTimeTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            Log.d(LOG_TAG, LoaderTime.this.hashCode() + " doInBackground");
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            Log.d(LOG_TAG, LoaderTime.this.hashCode() + " onPostExecute "
                    + result);
